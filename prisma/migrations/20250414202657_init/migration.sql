...
CREATE TABLE "User" (
    ...
    "settings" JSONB,
    "notificationSettings" JSONB DEFAULT '{"emailNotifications":{"newMessages":true,"dailyDigest":false,"weeklyDigest":true,"systemNotifications":true},"webNotifications":{"realTime":true,"errors":true,"updates":false}}',
